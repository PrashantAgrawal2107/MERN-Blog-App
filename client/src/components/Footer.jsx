      ...
      <div className='w-full max-w-7xl mx-auto'>
        <div className='grid w-full justify-between sm:flex md:grid-cols-1'>
          ...
          <div className='grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6'>
            ...
            <div>
              ...
              <Footer.LinkGroup col>
                <Footer.Link as={Link} to="/policy">Privacy Policy</Footer.Link>
                <Footer.Link as={Link} to="/policy">Terms &amp; Conditions</Footer.Link>
              </Footer.LinkGroup>
            </div>
          </div>
        </div>
        ...
        <div className='w-full sm:flex sm:items-center sm:justify-between'>
          ...
          <div className="flex gap-6 sm:mt-0 mt-4 sm:justify-center">
            ...
            <Footer.Icon href='https://www.instagram.com/prashantagrawal_2107' icon={BsInstagram}/>
            <Footer.Icon href='#' icon={BsTwitter}/>
            <Footer.Icon href='https://github.com/PrashantAgrawal2107' icon={BsGithub}/>
            <Footer.Icon href='https://www.linkedin.com/in/prashant-agrawal-aa7a55253/' icon={BsLinkedin}/>
